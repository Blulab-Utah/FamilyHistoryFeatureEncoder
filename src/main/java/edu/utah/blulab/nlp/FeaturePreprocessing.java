...
public class FeaturePreprocessing {
    ...
    public static StringBuilder getPOS(String subset) throws IOException {
        ...
        tokenModelIn = new FileInputStream(Encoder.class.getResource("/bin/en-token.bin").getPath());
        ...
        posModelIn = new FileInputStream(Encoder.class.getResource("/bin/en-pos-maxent.bin").getPath());
